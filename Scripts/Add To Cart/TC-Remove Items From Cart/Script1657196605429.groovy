...
Mobile.tap(findTestObject('Cart_Object/ShoppingCart_Object/btn_Remove'), 0)

Mobile.verifyElementVisible(findTestObject('Cart_Object/ShoppingCart_Object/txtView_Do you want to clear your all order'), 
    0)

Mobile.tap(findTestObject('Cart_Object/ShoppingCart_Object/btn_YES(Remove)'), 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Cart_Object/ShoppingCart_Object/txtView_Whoops, your cart is empty'), 0)
