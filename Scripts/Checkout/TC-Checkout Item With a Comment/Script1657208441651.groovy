...
Mobile.tap(findTestObject('CheckoutPage_Object/txtView_COD (Cash On Delivery)'), 0)
...
Mobile.tap(findTestObject('CheckoutPage_Object/txtField_Comment'), 0)

Mobile.setText(findTestObject('CheckoutPage_Object/txtField_EmptyComment'), 'Rumah nomor 7', 0)
